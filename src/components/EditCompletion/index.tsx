...
interface CompletionProps {
  ...
  textChangeHandler: (t: string, i: number) => void;
  editSaveHandler: (n: number) => void;
}
      ...
      <div className="flex">
        <div className="w-[70%] mr-4">
          <textarea
            ...
            onChange={(e) => textChangeHandler(e.target.value, index)}
            id="message"
            rows={4}
        ...
        <div className="w-[30%] border-l-2 border-gray-300">
          <div className="flex justify-around">
            <Button disabled text="1" onClick={() => rankChangeHandler(1, index)} active={completion?.active === 1} />
            <Button disabled text="2" onClick={() => rankChangeHandler(2, index)} active={completion?.active === 2} />
            <Button disabled text="3" onClick={() => rankChangeHandler(3, index)} active={completion?.active === 3} />
            {completion?.active === 0 ? (
              ...
              <svg className="h-8 w-8 self-center fill-red-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <div className="p-4">
            <Button text="Save Edits" onClick={() => editSaveHandler(index)} />
          </div>
        </div>
      </div>
    </div>
